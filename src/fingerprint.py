...
def get_peaks(audio, n_fft: int = 2048, hop_length: int = 512, threshold: int = -40) -> list:
...
def generate_fingerprints(peaks: List[Tuple[float, float]], fan_value: int = 5, min_delta: float = 0, max_delta: float = 200) -> \
        List[Dict[str, any]]:
